...
public interface CheckoutMapper {
    ...
    ProductValidationItem toProductValidationItem(CheckoutItem checkoutItem);

    List<ProductValidationItem> toProductValidationItems(List<CheckoutItem> checkoutItems);
}
